...
namespace CatFactory.ObjectOrientedProgramming
{
    ...
    public class ClassDefinition : ObjectDefinition, IClassDefinition
    {
        ...
        {
            get => m_constants ?? (m_constants = new List<ConstantDefinition>());
        ...
        {
            get => m_constructors ?? (m_constructors = new List<ClassConstructorDefinition>());
        ...
        {
            get => m_indexers ?? (m_indexers = new List<IndexerDefinition>());
        ...
        {
            get => m_fields ?? (m_fields = new List<FieldDefinition>());
            set => m_fields = value;
        }
    }
}
