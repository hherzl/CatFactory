...
public class PropertyDefinition : IMemberDefinition
{
    ...
    /// <param name="type">Type</param>
    /// <param name="name">Name</param>
    /// <param name="isAutomatic">Is automatic</param>
    /// <param name="attribs">Metadata attributes</param>
    public PropertyDefinition(string type, string name, bool isAutomatic = false, params MetadataAttribute[] attribs)
    {
        Type = type;
        Name = name;
    ...
    /// <param name="isAutomatic">Is automatic</param>
    /// <param name="attribs">Metadata attributes</param>
    public PropertyDefinition(AccessModifier accessModifier, string type, string name, bool isAutomatic = false, params MetadataAttribute[] attribs)
    {
        AccessModifier = accessModifier;
        Type = type;
        Name = name;
